...
import { clearCartItems, applyCoupon, removeCoupon } from '../features/cart/cartSlice';
...
const PlaceOrderScreen = () => {
  ...
  const { cartItems, shippingAddress, paymentMethod, itemsPrice, shippingPrice, taxPrice, totalPrice, coupon, couponDiscount } =
    cart;
