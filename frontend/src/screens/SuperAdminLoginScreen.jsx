    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="relative w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm">Buybee System Administration</p>
        </div>
          ...
          <form onSubmit={submitHandler} className="space-y-5">
            <div>
              ...
              <input
                ...
                required
                autoFocus
                placeholder="superadmin@buybee.com"
            ...
            >
              {isLoading ? <Loader /> : 'Sign In to Super Admin Portal'}
            </button>
          </form>
        </div>
